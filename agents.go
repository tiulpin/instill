...
var agents = [...]agent{
	...
	{"antigravity", "Antigravity", ".agents/skills", "~/.gemini/antigravity/skills", d("~/.gemini/antigravity")},
	...
	{"cline", "Cline", ".agents/skills", "~/.agents/skills", d("~/.cline")},
	...
	{"cortex", "Cortex Code", ".cortex/skills", "~/.snowflake/cortex/skills", d("~/.snowflake/cortex")},
	{"crush", "Crush", ".crush/skills", "~/.config/crush/skills", d("~/.config/crush")},
	{"cursor", "Cursor", ".agents/skills", "~/.cursor/skills", d("~/.cursor")},
	{"deepagents", "Deep Agents", ".agents/skills", "~/.deepagents/agent/skills", d("~/.deepagents")},
	...
	{"replit", "Replit", ".agents/skills", "$XDG_CONFIG_HOME/agents/skills", d(".replit")},
	...
	{"warp", "Warp", ".agents/skills", "~/.agents/skills", d("~/.warp")},
